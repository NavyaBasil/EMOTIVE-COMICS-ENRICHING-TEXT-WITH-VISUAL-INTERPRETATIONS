...
You may need to install the dependencies using:<br>
pip install flask torch diffusers transformers pillow numpy controlnet-aux speechrecognition xformers<br>
